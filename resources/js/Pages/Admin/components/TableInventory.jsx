...
import OptionsTableInventory from "@/Pages/Admin/components/OptionsTableInventory.jsx";
                    ...
                    { datos.length > 0 ? datos.map((datos, index) => (
                            <tr className="font-light text-sm" key={index}>
                                ...
                                <td className="py-2 px-2">
                                    {datos?.responsible?.name ?
                                        <a href={"/admin/ver-responsable/"+datos?.responsible?.id} className={"hover:text-gray-400"} target={"_blank"}>
                                            {datos?.responsible?.name}
                                        </a>
                                        :
                                        'Sin responsable'
                                ...
                                <td className="p-2">
                                    <Dropdown>
                                        ...
                                        <Dropdown.Content width={"max"} contentClasses={"bg-neutral-900 py-2 z-100"}>
                                            <OptionsTableInventory id={datos?.id}/>
                                        </Dropdown.Content>
                                    </Dropdown>
                                </td>
                            </tr>
