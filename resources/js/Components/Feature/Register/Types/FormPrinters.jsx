...
const initialState = {
    type_printer: '', //tipo de impresora
    printing_technology: '', //tecnología de impresión
    paper_sizes_supported: '', //tamaños de papel soportados
    duplex_printing: '', //es impresión dúplex
    ink_or_toner: '' //tinta o tóner
}

export const FormPrinters = ({setData, data, type}) => {
